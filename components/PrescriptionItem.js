      ...
      <View>
        <View style={styles.dateTime}>
          <Text style={styles.dateTimeText}>
            {pres.pres?.billing.billingDate.slice(0, 10)}
          </Text>
          <Text style={styles.dateTimeText}>
            {pres.pres?.billing.billingDate.slice(11, 16)}
          </Text>
        </View>
        ...
        <View
          ...
          <View>
            ...
            <View
              ...
              <Text style={[styles.dateTimeText, {marginRight: 10}]}>
                Total:{pres.pres.billing.totalAmount}
              </Text>
              <Text style={[styles.dateTimeText]}>
                Due:{pres.pres.billing.dueAmount}
              </Text>
            </View>
          </View>
